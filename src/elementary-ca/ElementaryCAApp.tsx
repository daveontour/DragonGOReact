            ...
            <div className="dragon-sidebar-panel elementary-ca-sidebar-panel">
              <Stack direction="vertical" gap={3}>
                ...
                <p className="elementary-ca-hint">
                  ...
                  <br />
                  <br />
                  <a href="https://en.wikipedia.org/wiki/Elementary_cellular_automaton" target="_blank" rel="noopener noreferrer">
                    Learn more about Elementary Cellular Automata - Wikipedia
                  </a>
                  <br />
                  <br />
                  <a href="https://mathworld.wolfram.com/ElementaryCellularAutomaton.html" target="_blank" rel="noopener noreferrer">
                    Learn more about Elementary Cellular Automata - Wolfram MathWorld
                  </a>
                </p>
              </Stack>
            </div>
