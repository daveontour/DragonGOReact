...
import CurveStatsModal from "../dialogs/CurveStatsModal";
import TileInspectModal from "../dialogs/TileInspectModal";
import {
  getTileStats,
  RequestConfig,
  TileStats,
...
export default function ControlLayoutButtons({
  ...
  const downloadDragonCurveSVG = () => {
    ...
    const svg = document.getElementById("imageHTMLElement") as HTMLElement;
