...
import FoldsModal from "../dialogs/RawConfigModal";
import ConfigSlideShowModal from "../dialogs/ConfigSlideShowModal";
import FoldsHelpModal from "../dialogs/FoldsHelpModal";
import RendererHelpModal from "../dialogs/RendererHelpModal";
import LoadCurveModal from "../dialogs/LoadCurveModal";
import SaveCurveModal from "../dialogs/SaveCurveModal";
import { getDragonSVG, getDragonSizeSVG, getPlansDisplaySVG, getPlansSizeSVG } from "../engine/svg";
...
import { downloadSVG, downloadJSON } from "../downloadUtils";
import { buildSavedConfig } from "../savedConfig";
import { applyNoCellsOverrides } from "../buildRequestConfig";
import { schedulePathAnimation } from "../pathAnimation";
...
export default function ControlLayout({
  ...
  const generate = (
    ...
    const json = JSON.stringify(buildSavedConfig(config), null, 2);
